$(document).ready(function(){
    ...
    // nav li를 클릭했을때, scroll의 위치가 변경된다.
    // nav li를 클릭했을때, 각 li의 순번을 찾고 그 순번에 맞게 scroll의 위치를 매번 변경해라.
    ...
    $('.wel').click(function(){
        ...
        // ^로고를 누르고 웰컴 눌렀을때 네비가 첫번째로 변경되어있는것

    })

    $(window).scroll(function(){

        // 스크롤의 위치값을 확인하고 스크롤의 값이 section의 높이만큼 내려왔을때부터
        // nav가 보여라.
